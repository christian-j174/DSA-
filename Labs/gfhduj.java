...
public class gfhduj {
    ...
    public void print(PrintStream out) {
        ...
        private void rehash() {
            ...
            // Temporary saving old buckets and updating the buckets to newBuckets
            Bucket<K,V>[] oldBuckets = buckets;
            buckets = newBuckets;
            currentSize = 0;  // reset currentSize because put() increments it
        
            for(Bucket<K,V> b : oldBuckets) {
                if(b.isInUse()) {
