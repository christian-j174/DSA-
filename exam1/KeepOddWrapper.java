...
/*
 * With this approach, when an even-indexed element is removed, 
 * the indices of the items yet to be processed are unaffected, 
 * making it a safer way to modify the collection during iteration.
*/
