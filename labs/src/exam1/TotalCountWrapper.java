...
public class TotalCountWrapper {
	...
	public static class ArrayList<E> implements List<E> {
		...
		public int removeDuplicate() {
			...
			for(int i = 1; i < this.size(); i++) {
				...
				if(this.get(i-1).equals(this.get(i))) {
					this.removePos(i);
					counter++;
				}
			}
	...
	public static void main(String[] args) {
	    System.out.println("Testing removeDuplicate");
	    ...
	    // Call removeDuplicate and get the count of removed duplicates
	    int removedCount = result.removeDuplicate();

	    // Print the list after removing duplicates
	    System.out.println("List after removing duplicates: " + result);

	    // Print the count of removed duplicates
	    System.out.println("Removed " + removedCount + " duplicates.");
	}
